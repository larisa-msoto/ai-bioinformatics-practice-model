...
* AI regulatory alignment
    * Monitor rapidly shifting regional and global AI legal frameworks to dynamically align pipeline deployments with local jurisdiction mandates.

* ACTIVE: Ethical evaluation
...
* ISCB Computer Science Domain
    * [ISCB I3: Construct and maintain bioinformatics computing infrastructure.](https://competency.ebi.ac.uk/framework/iscb/3.0/competencies/I3)
    * [ISCB G3: Contribute to the design of user-centric bioinformatics tools.](https://competency.ebi.ac.uk/framework/iscb/3.0/competencies/G3)
...
* ISCB Professional Conduct
    * [ISCB M3: Engage in continuing professional development](https://competency.ebi.ac.uk/framework/iscb/3.0/competencies/M3)
...
* ISCB Professional Conduct
    ...
    * [ISCB K3: Communicate meaningfully with a range of audiences.](https://competency.ebi.ac.uk/framework/iscb/3.0/competencies/K3)

* ISCB Bioscience Domain
    * [ISCB C3: Have a positive impact on scientific discovery through bioinformatics.](https://competency.ebi.ac.uk/framework/iscb/3.0/competencies/C3)
