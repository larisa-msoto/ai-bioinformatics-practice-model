...
**Diligence** is _"taking responsibility for what we do with AI and how we use it"_ ([Anthropic's 4D Framework for AI fluency](https://www-cdn.anthropic.com/334975cdec18f744b4fa511dc8518bd8d119d29d.pdf?ref=hackshackers.com)). In bioinformatics, it means assuming accountability for the impact of agentic AI solutions. This is not only about adhering to international standards for ethical and safe AI use, but also maintaining the cognitive abilities to remain critical of AI-generated outputs and complete tasks manually when AI agents fail.
...
!!! abstract "Practice areas on this page"
    ...
    2. [Securing digital asset longevity and sustainability](#2-securing-digital-asset-longevity-and-sustainability)
    3. [Countering mental dependency while preserving technical mastery](#3-countering-mental-dependency-while-preserving-technical-mastery)
    4. [Nurturing a supportive and responsible scientific community](#4-nurturing-a-supportive-and-responsible-scientific-community)
    5. [Guiding institutional strategy and cross-sector diplomacy](#5-guiding-institutional-strategy-and-cross-sector-diplomacy)
    6. [Elevating workforce capacity and educational legacy](#6-elevating-workforce-capacity-and-educational-legacy)
...
## 1. Ensuring pipeline governance and regulatory compliance
...
## 2. Securing digital asset longevity and sustainability
...
| Category | Competency | Source |
| --- | --- | --- |
| **Visionary stewardship** | Design long-term technical roadmaps, governance models, and sustainability plans to secure the permanent operational longevity of bioinformatics initiatives. | <span class="tag tag-4dbio">4D-Bio</span> |
| **Scientific diplomacy** | Navigate complex negotiations and communicate impact across academia, industry, and government sectors to align competing interests and influence decision makers. | <span class="tag tag-4dbio">4D-Bio</span> |

## 6. Elevating workforce capacity and educational legacy

| Category | Competency | Source |
| --- | --- | --- |
| **Generational mentorship** | Develop early-career talent by actively mentoring them to leverage generative AI systems appropriately, critically, and responsibly. | <span class="tag tag-4dbio">4D-Bio</span> |
| **Pedagogical dissemination** | Design open-access learning resources that leverage cloud and AI technologies to democratize access to scientific discoveries and dismantle structural educational inequities. | <span class="tag tag-4dbio">4D-Bio</span> |
